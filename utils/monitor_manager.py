...
class MonitorManager:
    ...
    def refresh_monitors(self) -> List[Dict]:
        ...
        Returns:
            ...
            - id: Logical ID based on position (for workspace assignment)
            - hypr_id: Original Hyprland monitor ID (for window placement)
            - name, width, height, x, y, scale
        """
        self._monitors = []
        ...
        try:
            ...
            for i, monitor in enumerate(sorted_monitors):
                ...
                hypr_id = monitor.get('id', i)  # Store original Hyprland ID
                ...
                self._monitors.append({
                    ...
                    'hypr_id': hypr_id,  # Original Hyprland monitor ID
                    'name': monitor_name,
                ...
                # Initialize states for new monitors using logical ID
